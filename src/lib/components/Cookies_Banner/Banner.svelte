<script>
	...
	export let acceptLabel = 'Accetta i cookies';
	export let rejectLabel = 'Rifiuta i cookies';
	export let settingsLabel = 'Impostazioni';
	export let closeLabel = 'Chiudi impostazioni';
...
{#if showEditIcon}
	<button class="cookieConsentToggle" on:click={show} transition:fade>
